...
export function AjayAparnaTheme({ invite }: { invite: InviteData }) {
  ...
  return (
    <div className="ajay-aparna-theme relative w-full min-h-screen">
      ...
      {/* Floating Exit Link (Dynamic Exit Link from design) */}
      <Link
        href="/"
        className="fixed top-4 left-4 z-50 bg-[#802a2a]/80 backdrop-blur-md text-[#f0e6d2] px-4 py-2 rounded-full flex items-center gap-2 hover:bg-[#802a2a] transition-colors border border-[#c5a880]/30 text-sm font-semibold"
      >
